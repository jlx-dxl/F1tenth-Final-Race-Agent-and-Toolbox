...
class PurePursuit(Node):
    ...
    def __init__(self):
        ...
        self.scan_sub_ = self.create_subscription(LaserScan, scan_topic, self.laser_scan_callback, 10)
...
########################################### Callback ############################################
    ...
    def laser_scan_callback(self, data):
        ...
        ranges = data.ranges[480:600]
        angle_increment = data.angle_increment
        angle_min = data.angle_min + 480 * angle_increment
    ...
    def pose_callback(self, pose_msg):
        ...
        if self.count>5:
            target_speed = update_speed(self.speed, self.opp_vel + speed_bias, coeff=speed_coefficient)
            message.drive.speed = target_speed
            print(self.count, "Following Mode!!!")
        else:
            target_speed = update_speed(self.speed, target_v, coeff=speed_coefficient)
